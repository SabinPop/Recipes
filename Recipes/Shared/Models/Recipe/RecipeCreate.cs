...
namespace Recipes.Shared.Models.Recipe
{
    public class RecipeCreate
    {
        ...
        private int _weight 
        {
            get
            {
                return IngredientsWithQuantities.Select(x => x.Quantity).Sum();
            }        
        }
        */
        public string UserName { get; set; }

        public HashSet<IngredientWithQuantity.IngredientWithQuantity> IngredientsWithQuantities { get; set; }
            = new HashSet<IngredientWithQuantity.IngredientWithQuantity>();
